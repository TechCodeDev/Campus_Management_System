...
<div class="container">
<br><h2>CollegeProfile</h2>
 
  
  <div class="card bg-primary text-white">
    <div class="card-body">College Name&nbsp;:&nbsp;<?php echo strtoupper("$name");?></div>
    <div class="card-body">Gmail&nbsp;:&nbsp;<?php echo strtoupper(" $gmail");?></div>
    <div class="card-body">College Code&nbsp;:&nbsp;<?php echo strtoupper(" $company_offical_website");?></div>
    <div class="card-body">College Website&nbsp;:&nbsp;<?php echo strtoupper(" $contact_no");?></div>
    <div class="card-body">Description of College&nbsp;:&nbsp;<?php echo strtoupper("  $no_of_employ");?></div>
    <div class="card-body">Phone Number&nbsp;:&nbsp;<?php echo strtoupper("$domain");?></div>
